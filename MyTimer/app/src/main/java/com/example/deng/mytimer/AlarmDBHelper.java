...
import com.example.deng.mytimer.AlarmContract.Alarm;
import java.util.ArrayList;
import java.util.List;

/**
 * Created by deng on 2015/11/13.启动AlarmListActivity时会调用AlarmDBHelper，如果没有数据库，会创建数据库，有的话先查询
 *
 */
...
//populateContent方法将数据封装到values中
...
//数据库查询单个数据，并且返回populateContent封装好values
